...
export function generateExcelTemplate() {
  const data = [
    ...
    { id: 71, categoryId: 7, categoryName: "屋台", name: "肉巻きドッグ", price: 480, stock: 10 },
    { id: 72, categoryId: 7, categoryName: "屋台", name: "フランクフルト", price: 330, stock: 10 },
    { id: 73, categoryId: 7, categoryName: "屋台", name: "シャーベットアイス", price: 380, stock: 10 }
  ];
